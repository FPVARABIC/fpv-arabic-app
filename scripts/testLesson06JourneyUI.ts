...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lesson 15 legacy intact ──
    {
    ...
    {
      // Lessons 7, 8, 9, 10, 11, 12, 13, and 14 were deliberately migrated onto
      // the journey architecture in Phases 9-16 (see testLesson07JourneyUI.ts /
