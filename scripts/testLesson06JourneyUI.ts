...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lesson 10 diagram intact ──
    {
    ...
    {
      // Lessons 7, 8, and 9 were deliberately migrated onto the journey
      // architecture in Phases 9-11 (see testLesson07JourneyUI.ts /
