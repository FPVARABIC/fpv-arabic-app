...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lesson 17 legacy intact ──
    {
    ...
    {
      // Lessons 7, 8, 9, 10, 11, 12, 13, 14, 15, and 16 were deliberately
      // migrated onto the journey architecture in Phases 9-18 (see testLesson07JourneyUI.ts /
