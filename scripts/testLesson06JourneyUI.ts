...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lesson 16 legacy intact ──
    {
    ...
    {
      // Lessons 7, 8, 9, 10, 11, 12, 13, 14, and 15 were deliberately migrated
      // onto the journey architecture in Phases 9-17 (see testLesson07JourneyUI.ts /
