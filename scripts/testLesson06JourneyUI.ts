...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lessons 17/18 and their section are gone ──
    {
    ...
    {
      // Lessons 7-16 were deliberately migrated onto the journey architecture
      // in Phases 9-18 (see testLesson07JourneyUI.ts /
