...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lesson 11 legacy intact ──
    {
    ...
    {
      // Lessons 7, 8, 9, and 10 were deliberately migrated onto the journey
      // architecture in Phases 9-12 (see testLesson07JourneyUI.ts /
