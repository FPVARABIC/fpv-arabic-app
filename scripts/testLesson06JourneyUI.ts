...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-5 still use their own journeys; Lesson 12 legacy intact ──
    {
    ...
    {
      // Lessons 7, 8, 9, 10, and 11 were deliberately migrated onto the
      // journey architecture in Phases 9-13 (see testLesson07JourneyUI.ts /
