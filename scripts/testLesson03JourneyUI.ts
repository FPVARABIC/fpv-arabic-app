...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lesson 1 & 2 still use their own journeys; Lessons 17/18 and their section are gone ──
    {
    ...
    {
      // Lessons 4-16 were deliberately migrated onto the journey architecture
      // in Phases 6-18 (see testLesson04JourneyUI.ts / testLesson05JourneyUI.ts /
