...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-3 still use their own journeys; Lesson 12 legacy intact ──
    {
    ...
    {
      // Lessons 5, 6, 7, 8, 9, 10, and 11 were deliberately migrated onto the
      // journey architecture in Phases 7-13 (see testLesson05JourneyUI.ts /
      // testLesson06JourneyUI.ts / testLesson07JourneyUI.ts /
      // testLesson08JourneyUI.ts / testLesson09JourneyUI.ts /
      // testLesson10JourneyUI.ts / testLesson11JourneyUI.ts) — Lesson 12 is
