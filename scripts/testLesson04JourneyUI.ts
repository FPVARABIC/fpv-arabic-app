...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-3 still use their own journeys; Lessons 17/18 and their section are gone ──
    {
    ...
    {
      // Lessons 5-16 were deliberately migrated onto the journey architecture
      // in Phases 7-18 (see testLesson05JourneyUI.ts /
