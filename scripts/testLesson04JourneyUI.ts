...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-3 still use their own journeys; Lesson 13 legacy intact ──
    {
    ...
    {
      // Lessons 5, 6, 7, 8, 9, 10, 11, and 12 were deliberately migrated onto
      // the journey architecture in Phases 7-14 (see testLesson05JourneyUI.ts /
      ...
      // testLesson12JourneyUI.ts) — Lesson 13 is now the nearest still-legacy
