...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-3 still use their own journeys; Lesson 11 legacy intact ──
    {
    ...
    {
      // Lessons 5, 6, 7, 8, 9, and 10 were deliberately migrated onto the
      // journey architecture in Phases 7-12 (see testLesson05JourneyUI.ts /
