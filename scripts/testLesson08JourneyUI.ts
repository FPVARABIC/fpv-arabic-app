...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-7 still use their own journeys; Lesson 12 legacy intact ──
    {
    ...
    {
      // Lessons 9, 10, and 11 were deliberately migrated onto the journey
      // architecture in Phases 11-13 (see testLesson09JourneyUI.ts /
