...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-7 still use their own journeys; Lesson 13 legacy intact ──
    {
    ...
    {
      // Lessons 9, 10, 11, and 12 were deliberately migrated onto the journey
      // architecture in Phases 11-14 (see testLesson09JourneyUI.ts /
