...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-7 still use their own journeys; Lesson 11 legacy intact ──
    {
    ...
    {
      // Lessons 9 and 10 were deliberately migrated onto the journey
      // architecture in Phases 11-12 (see testLesson09JourneyUI.ts /
