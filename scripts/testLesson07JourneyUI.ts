...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-6 still use their own journeys; Lesson 16 legacy intact ──
    {
    ...
    {
      // Lessons 8, 9, 10, 11, 12, 13, 14, and 15 were deliberately migrated onto
      // the journey architecture in Phases 10-17 (see testLesson08JourneyUI.ts /
