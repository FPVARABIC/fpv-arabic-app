...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-6 still use their own journeys; Lesson 14 legacy intact ──
    {
    ...
    {
      // Lessons 8, 9, 10, 11, 12, and 13 were deliberately migrated onto the
      // journey architecture in Phases 10-15 (see testLesson08JourneyUI.ts /
