...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-6 still use their own journeys; Lessons 17/18 and their section are gone ──
    {
    ...
    {
      // Lessons 8-16 were deliberately migrated onto the journey architecture
      // in Phases 10-18 (see testLesson08JourneyUI.ts /
