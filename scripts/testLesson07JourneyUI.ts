...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-6 still use their own journeys; Lesson 13 legacy intact ──
    {
    ...
    {
      // Lessons 8, 9, 10, 11, and 12 were deliberately migrated onto the
      // journey architecture in Phases 10-14 (see testLesson08JourneyUI.ts /
