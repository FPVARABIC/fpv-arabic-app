...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-4 still use their own journeys; Lesson 10 diagram intact ──
    {
    ...
    {
      // Lessons 6, 7, 8, and 9 were deliberately migrated onto the journey
      // architecture in Phases 8-11 (see testLesson06JourneyUI.ts /
