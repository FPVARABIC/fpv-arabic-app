...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-4 still use their own journeys; Lesson 14 legacy intact ──
    {
    ...
    {
      // Lessons 6, 7, 8, 9, 10, 11, 12, and 13 were deliberately migrated
      // onto the journey architecture in Phases 8-15 (see testLesson06JourneyUI.ts /
      ...
      // testLesson13JourneyUI.ts) — Lesson 14 is now the nearest still-legacy
