...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-4 still use their own journeys; Lesson 15 legacy intact ──
    {
    ...
    {
      // Lessons 6, 7, 8, 9, 10, 11, 12, 13, and 14 were deliberately migrated
      // onto the journey architecture in Phases 8-16 (see testLesson06JourneyUI.ts /
      ...
      // testLesson13JourneyUI.ts / testLesson14JourneyUI.ts) — Lesson 15 is
