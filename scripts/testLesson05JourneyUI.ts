...
async function main() {
  ...
  try {
    ...
    // ── Regression: Lessons 1-4 still use their own journeys; Lessons 17/18 and their section are gone ──
    {
    ...
    {
      // Lessons 6-16 were deliberately migrated onto the journey architecture
      // in Phases 8-18 (see testLesson06JourneyUI.ts /
