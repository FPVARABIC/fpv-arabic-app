...
export const videoUnits: VideoUnit[] = [
  ...
  },
  {
    ...
    specs: { weightG: 22.3 },
    compatibilityTags: { droneTypes: ['freestyle', 'racing'], batteryVoltages: [4, 6] },
    whyChoose: 'خيار ممتاز لمن يريد HDZero على المقاسات من 3 إلى 5 إنش مع latency منخفض.',
    notFor: 'لا تختاره إذا تريد تسجيل بأعلى جودة صورة ممكنة أو نظام DJI جاهز.',
    upgradePath: 'HDZero Race VTX أو DJI O4 حسب الهدف',
    lastReviewed: '2026-07',
    confidence: 'مؤكد',
    quickTags: {
      whyTag: 'أقل latency — HDZero لمقاسات من 3 إلى 5 إنش',
  ...
  },
  {
    ...
    safetyNotes: ['لا تشغلها بدون هوائي؛ احترم قوانين القدرة المسموحة في بلدك خاصة عند استخدام 800mW-1000mW.'],
    buildNotes: [
