...
export const motors: Motor[] = [
  {
    ...
    compatibilityTags: { droneTypes: ['freestyle-5-inch'], batteryVoltages: [4], frameSizeInch: 5 },
  ...
  },
  {
    ...
    compatibilityTags: { droneTypes: ['freestyle-5-inch'], batteryVoltages: [4, 6], frameSizeInch: 5 },
  ...
  },
  {
    ...
    priceRangeEGP: [650, 900],
    specs: { kv: 1700, statorSize: '2207', weightG: 36, shaftDiameterMm: 5, maxThrustG: 1950, compatibleVoltages: [6] },
    compatibilityTags: { droneTypes: ['freestyle-5-inch'], batteryVoltages: [6], frameSizeInch: 5 },
