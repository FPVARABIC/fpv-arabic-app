...
export const videoSystems: VideoSystem[] = [
  {
    ...
    buildNotes: [
      ...
      'مدى طويل: بعض وحدات VTX من فئة Analog تدعم قدرة قابلة للتبديل تصل حتى 800mW-1000mW حسب المنتج المحدد (وليس كل المنتجات في هذه الفئة)؛ هذا هو أساس دعم مدى طويل هنا، وليس رقماً ثابتاً لكل نظام Analog.',
    ],
  },
  {
