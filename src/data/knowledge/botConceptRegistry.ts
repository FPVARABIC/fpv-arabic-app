...
// ── Lookup helpers ────────────────────────────────────────────────────────────
// These are read-only utilities for future routing code.
// Phase 0: not yet used by any runtime code.

/**
 * Returns the BotConcept for the given ID, or undefined if not found.
 * O(n) — registry is small, no index needed at this scale.
 */
...
/**
 * Returns all concepts that have safetyLevel === 'critical'.
 * Useful for safety-first routing guards.
 */
...
/**
 * Returns all concepts directly related to the given concept ID
