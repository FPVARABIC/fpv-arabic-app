...
export const bfPageRegistry: BfRegistryEntry[] = [
  ...
  { id: 'setup', officialId: 'setup', officialTitle: 'Setup', titleAr: 'الإعداد الأولي', officialOrder: 6, connectionState: 'connected', scope: 'universal', safetyLevel: 'caution', contentStatus: 'architecture-preview', page: setupPage },
  { id: 'failsafe', officialId: 'failsafe', officialTitle: 'Failsafe', titleAr: 'الحماية عند فقدان الإشارة', officialOrder: 7, connectionState: 'connected', scope: 'universal', safetyLevel: 'critical', contentStatus: 'not-started' },
  ...
  { id: 'motors', officialId: 'motors', officialTitle: 'Motors', titleAr: 'المحركات', officialOrder: 16, connectionState: 'connected', scope: 'universal', safetyLevel: 'critical', contentStatus: 'not-started' },
  ...
  { id: 'ports', officialId: 'ports', officialTitle: 'Ports', titleAr: 'المنافذ', officialOrder: 18, connectionState: 'connected', scope: 'universal', safetyLevel: 'warning', contentStatus: 'architecture-preview', page: portsPage },
