...
export const BotV2AssistantView: React.FC = () => {
  ...
  // Scroll message area to bottom after every new message.
  // Using scrollTop directly on the container avoids scrollIntoView
  // accidentally targeting the outer AppShell scroll container.
  useEffect(() => {
  ...
  return (
    <AppShell>
      ...
      <div className="flex flex-col h-[calc(100vh-9rem)]">
        ...
        {/* Input bar — always accessible at bottom */}
...
const BotV2Bubble: React.FC<BubbleProps> = ({ answer, onChip, onLink }) => {
  ...
  return (
    <div className="glass-card-sm p-3 space-y-2.5">
      ...
      {/* Risk badge — only rendered for non-none risk levels */}
      {badgeCls && badgeLabel && (
        <div>
      ...
      {/* Safety warning banner — visually dominant, always above the answer text */}
      {answer.warning && (
        <SafetyWarning
