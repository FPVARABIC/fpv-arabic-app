...
export const BottomNavigation: React.FC = () => {
  ...
  return (
    <>
      {/* "More" popup — constrained to 390px column */}
      {showMore && (
        <div className="fixed inset-0 z-40 bg-black/60 backdrop-blur-sm" onClick={() => setShowMore(false)}>
          <div className="absolute bottom-[4.5rem] left-0 right-0 flex justify-center px-4" onClick={e => e.stopPropagation()}>
            <div className="w-full max-w-[390px] card-feature p-4 fade-in">
