...
import {
  CATEGORY_ORDER, CATEGORY_LABEL_AR,
  COVERAGE_LABEL_AR, softwareByCategory,
...
export default function ProgrammingHub() {
  return (
    <div className="shell" style={{ paddingTop: 30, paddingBottom: 46, maxWidth: 1100 }}>
      ...
      <h1 className="page-title" style={{ margin: '14px 0 18px' }}>مركز البرامج</h1>

      {CATEGORY_ORDER.map(cat => (
        <section key={cat} className="admin-section" aria-labelledby={`cat-${cat}`}>
          <h2 id={`cat-${cat}`} style={{ marginBottom: 12 }}>{CATEGORY_LABEL_AR[cat]}</h2>
