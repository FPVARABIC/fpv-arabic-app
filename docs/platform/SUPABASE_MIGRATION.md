...
| 2 — RLS والسياسات | ✅ منجزة (`0002` + `0006`) — 79 تأكيداً على PostgreSQL حقيقي |
| 3 — Buckets وسياساتها | ✅ منجزة (`0003_storage.sql`) — 59 تأكيداً |
| 4 — Backend Adapter | ✅ منجزة (`web/lib/backend/`) — 146 تأكيداً |
| 5 — نقل الويب **كاملاً** | ✅ منجزة — صفر Firebase في runtime الويب وحزمه |
| 6 — التنظيف | ✅ منجزة — Netlify وApp Hosting أُزيلا بملفاتهما واختباراتهما |
| نقل Android | **مجمّد بأمر صريح** — لا يبدأ إلا بأمرك |
| البيانات (الاستيراد) | **محجوبة**: تحتاج اعتماد Firebase وSupabase معاً |
| تطبيق الهجرات | **بيدك**: `docs/platform/DEPLOY_VERCEL.md` خطوة ١ |
| نشر Vercel | **بيدك**: الدليل نفسه خطوة ٢ — بوابة شبكتي ترفض `vercel.com` |
